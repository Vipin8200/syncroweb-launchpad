...
const AdminAddIntern = () => {
  ...
  const addInternMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      ...
      // Admin adds intern directly with approved status
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Directly add an intern (auto-approved)</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              As an admin, interns you add are automatically approved and active.
            </CardDescription>
          </CardHeader>
          <CardContent>
